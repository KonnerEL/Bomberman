...
public class World1 extends JFrame {
    ...
    public World1() {
        ...
        setFocusable(true);
        setVisible(true);
        enemies.add(new Enemy(450, 50, 2, 2, 1, map));
        enemies.add(new Enemy(50, 450, 2, 2, 1, map));
        enemies.add(new Enemy(450, 450, 2, 2, 1, map));
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                boolean sw3 = false;
                while (true && !sw) {
                    label1.setText("      Vidas: " + LIFE + "                                        Nivel 1");
                    ...
                    try {
                        ...
                        if (LIFE == 0) {
                            ...
                            label1.setText("      Vidas: " + 0 + "                                        Nivel 1");
                            timer.stop();
                            soundplayer.stop();
                        }
