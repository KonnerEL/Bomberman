 ...
 * @author KonnerEL
 */
public class World2 extends JFrame {
    Random random;
    ...
    int[][] map = {
        ...
        {2, 1, 0, 1, 0, 1, 0, 0, 0, 0, 2},
        {2, 0, 2, 1, 2, 0, 2, 0, 2, 1, 2},
        {2, 1, 0, 1, 1, 1, 0, 1, 0, 1, 2},
    ...
    public World2() {
        ...
        setFocusable(true);
        setVisible(true);
        enemies.add(new Enemy(450, 50, 2, 2, 2, map));
        enemies.add(new Enemy(50, 450, 2, 2, 2, map));
        enemies.add(new Enemy(450, 450, 2, 2, 2, map));
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                boolean sw3 = false;
                while (true && !sw) {
                    label1.setText("      Vidas: " + LIFE + "                                        Nivel 2");
                    ...
                    try {
                        ...
                        if (LIFE == 0) {
                            ...
                            label1.setText("      Vidas: " + 0 + "                                        Nivel 2");
                            timer.stop();
                            soundplayer.stop();
                        }
